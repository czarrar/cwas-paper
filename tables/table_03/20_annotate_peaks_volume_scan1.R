...
easy_dir    <- "/home2/data/Projects/CWAS/tables/table_03/data_scan1"
...
write.csv(df, file=file.path(odir, "12_peaks_part1_scan1.csv"))
write.table(table(clust[clust!=0]), file=file.path(odir, "13_clusts_scan1.txt"))

...
easy_dir    <- file.path("/home2/data/Projects/CWAS/tables/table_04", dname)
...
odir <- "/home2/data/Projects/CWAS/tables/table_04"
write.csv(df, file=file.path(odir, sprintf("%s_peaks-volume.csv", opre)))
write.table(table(clust[clust!=0]), file=file.path(odir, sprintf("%s_clusts.txt", opre)))

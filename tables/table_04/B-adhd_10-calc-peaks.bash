...
sdist="${base}/adhd200_rerun/cwas/compcor_kvoxs_fwhm08"
indir="${sdist}/adhd_vs_tdc_run+gender+age+iq+mean_FD.mdmr/cluster_correct_v05_c05/easythresh"
outdir="${base}/tables/table_04/data_adhd"

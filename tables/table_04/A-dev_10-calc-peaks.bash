...
sdist="${base}/development+motion/cwas/compcor_kvoxs_smoothed"
indir="${sdist}/age+motion_sex+tr.mdmr/cluster_correct_v05_c05/easythresh"
outdir="${base}/tables/table_04/data_dev"

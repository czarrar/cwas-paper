...
mdmr_dir = "/home2/data/Projects/CWAS/development+motion/cwas_regress_motion/rois_random_k3200/age_sex+tr.mdmr"
...
brain.save_imageset(path.join(odir, "zpics_glm_regress_surface_%s_lh" % "only_age"), 
...
"""
odir = "/home/data/Projects/CWAS/development+motion/viz"
brain.save_imageset(path.join(odir, "zpics_glm_regress_surface_%s_lh" % "age_with_motion"), 
                    ['med', 'lat', 'ros', 'caud'], 'jpg')
...
"""
odir = "/home/data/Projects/CWAS/development+motion/viz"
brain.save_imageset(path.join(odir, "zpics_glm_regress_surface_%s_lh" % "motion_with_age"), 
                    ['med', 'lat', 'ros', 'caud'], 'jpg')

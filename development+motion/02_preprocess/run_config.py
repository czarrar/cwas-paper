...
workingDirectory = '/home2/data/Projects/POWER_2012/working_dir'

# Directory where C-PAC should place crash logs
crashLogDirectory = '/home2/data/Projects/POWER_2012/crash_logs'

# Directory where C-PAC should put processed data
sinkDirectory = '/home2/data/PreProc/POWER_2012'
...
templateDirectoryPath = '/home2/data/Projects/FCon1000/etc/centrality' 

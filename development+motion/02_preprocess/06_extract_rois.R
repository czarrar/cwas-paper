...
rbase <- "/home2/data/Projects/CWAS/share/development+motion/rois"
mask_file <- file.path(rbase, "mask_gray_4mm.nii.gz")

ks <- c(25,50,100,200,400,800,1600,3200)

sbase <- "/home2/data/Projects/CWAS/share/development+motion/subinfo"
func_files <- as.character(read.table(file.path(sbase, "02_funcpaths_4mm.txt"))[,1])

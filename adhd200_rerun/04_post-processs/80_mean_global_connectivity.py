...
maskfile = "/home2/data/Projects/CWAS/adhd200_rerun/rois/mask_gray_4mm_combined.nii.gz"
...
fpath = op.join(subdir, "30_compcor_funcpaths_4mm_combined_fwhm08.txt")
f = open(fpath, 'r')
...
np.savetxt(op.join(subdir, "mean_gcors_4mm_combined_fwhm08.txt"), mgs, fmt="%.5f")

...
funcpaths <- read.table(file.path(basedir, "subinfo/30_compcor_funcpaths_4mm_combined.txt"))[,1]
...
outfile <- file.path("/home2/data/Projects/CWAS/adhd200_rerun", "rois", "mask_gray_4mm_combined.nii.gz")

...
workingDirectory = '/home2/data/Projects/ADHD200/working_dir'

# Directory where C-PAC should place crash logs
crashLogDirectory = '/home2/data/Projects/ADHD200/crash_logs'

# Directory where C-PAC should put processed data
sinkDirectory = '/home2/data/PreProc/ADHD200'
...
templateDirectoryPath = '/home2/data/Projects/ADHD200/etc/centrality' 

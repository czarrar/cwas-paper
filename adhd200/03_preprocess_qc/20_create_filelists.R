...
subfile <- file.path(subdir, "04_subjects_matched.csv")
...
# Save
write.table(compcor_funcs, file=file.path(subdir, "05_compcor_funcpaths.txt"), 
            row.names=FALSE, col.names=FALSE)
write.table(global_funcs, file=file.path(subdir, "06_global_funcpaths.txt"), 
            row.names=FALSE, col.names=FALSE)

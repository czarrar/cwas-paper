...
grpfile     = op.join(setdir, "sca_fsl_meanGcor", "%s.grp" % scan)
matfile     = op.join(setdir, "sca_fsl_meanGcor", "%s.mat" % scan)
confile     = op.join(setdir, "sca_fsl_meanGcor", "%s.con" % scan)

wdir        = op.join(base, "nki/sca/%s_%s_meanGcor_working" % (scan, strategy))
odir        = op.join(base, "nki/sca/%s_%s_meanGcor_sink" % (scan, strategy))

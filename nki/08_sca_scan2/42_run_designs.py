...
wdir        = op.join(base, "nki/sca2/%s_%s_working" % (scan, strategy))
odir        = op.join(base, "nki/sca2/%s_%s_sink" % (scan, strategy))
...
sca_files   = joins(sca_dirs, "smoothed_zscore_scan2_peaks100_2mm.nii_roi_n%02i.nii.gz" % roi)

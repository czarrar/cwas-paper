...
base     <- "/home2/data/Projects/CWAS/nki/sca2"
...
maskfile <- "/home2/data/Projects/CWAS/nki/rois/mask_gray_2mm.nii.gz"
mask     <- read.mask(maskfile)
nvoxs    <- sum(mask)

roi_df   <- read.csv("/home2/data/Projects/CWAS/nki/sca2/seeds/rois_all_info.csv")
...
write.csv(df, file="/home/data/Projects/CWAS/nki/sca2/summarize_sca-iq.csv")

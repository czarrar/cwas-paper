/* Generated by Cython 0.15.1 on Thu Dec  1 18:08:50 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE__pandas___cppsandbox
...
int __pyx_module_is_main_pandas___cppsandbox = 0;
...
static PyObject *__pyx_pf_6pandas_11_cppsandbox_map_indices(PyObject *__pyx_self, PyObject *__pyx_v_values) {
  ...
  __pyx_t_6pandas_11_cppsandbox_i4 __pyx_t_2;
 ...
 *         mapping[i] = values[i]
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_values); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_n = __pyx_t_1;
 ...
 */
    ...
    (__pyx_v_mapping[__pyx_v_i]) = (*__Pyx_BufPtrStrided1d(__pyx_t_6pandas_11_cppsandbox_i4 *, __pyx_bstruct_values.buf, __pyx_t_4, __pyx_bstride_0_values));
  }
  ...
  __Pyx_AddTraceback("pandas._cppsandbox.map_indices", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_values);
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__cppsandbox(void)");
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init pandas._cppsandbox", __pyx_clineno, __pyx_lineno, __pyx_filename);

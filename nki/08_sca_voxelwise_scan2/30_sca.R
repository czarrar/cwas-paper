...
indir   <- file.path(base, "nki/sca_voxelwise_scan2/20_rois")
odir    <- file.path(base, "nki/sca_voxelwise_scan2/30_sca")
dir.create(odir)
...
clust1 <- read.nifti.image(file.path(base, "nki/sca_voxelwise_scan1/10_mdmr_data/cluster_mask.nii.gz"))
clust2 <- read.nifti.image(file.path(base, "nki/sca_voxelwise_scan2/10_mdmr_data/cluster_mask.nii.gz"))

print(table(clust1[vox_inds[1:25]]))
print(table(clust2[vox_inds[1:25]]))
print(table(clust2))

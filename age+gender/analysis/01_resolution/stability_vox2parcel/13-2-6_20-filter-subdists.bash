...
rm /home2/data/Projects/CWAS/age+gender/01_resolution/cwas/rois_random_k*/partial_subdists/fold??_subdist.*


###
# Second for voxelwise
###
...
# Remove the subject distances (only keep gower distance matrices)
rm /home2/data/Projects/CWAS/age+gender/01_resolution/cwas/voxelwise/partial_subdists/fold??_subdist.*

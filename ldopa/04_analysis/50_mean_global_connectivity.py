...
maskfile = "/home2/data/Projects/CWAS/ldopa/rois/mask_for_ldopa_gray_4mm.nii.gz"
...
fpath = op.join(subdir, "02_all_funcpaths_4mm_fwhm08.txt")
f = open(fpath, 'r')
...
np.savetxt(op.join(subdir, "mean_gcors_all_4mm_fwhm08.txt"), mgs, fmt="%.5f")

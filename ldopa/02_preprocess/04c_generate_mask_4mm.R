...
funcpaths <- read.table(file.path(basedir, "subinfo/02_all_funcpaths_4mm.txt"))[,1]
...
outfile <- file.path(basedir, "rois", "mask_for_ldopa_gray_4mm.nii.gz")
std_mask_file <- file.path(basedir, "rois", "gray_4mm.nii.gz")

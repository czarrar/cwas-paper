...
workingDirectory = '/home2/data/Projects/LDOPA/working_dir'

# Directory where C-PAC should place crash logs
crashLogDirectory = '/home2/data/Projects/LDOPA/crash_logs'

# Directory where C-PAC should put processed data
sinkDirectory = '/home2/data/PreProc/LDOPA'
...
templateDirectoryPath = '/home2/data/Projects/LDOPA/etc/centrality' 

...
obase = "/home2/data/Projects/CWAS/ldopa/spatial_cluster"

# functions for connectivity metric
from make_local_connectivity_ones import *

# name of the maskfile that we will be using
roidir = "/home2/data/Projects/CWAS/share/ldopa/rois"
maskfile = path.join(roidir, "mask_for_ldopa_gray_4mm.nii.gz")

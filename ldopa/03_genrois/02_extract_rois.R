...
rbase <- "/home2/data/Projects/CWAS/share/ldopa/rois"
mask_file <- file.path(rbase, "mask_for_ldopa_gray_4mm.nii.gz")

ks <- c(25,50,100,200,400,800,1600,3200)

sbase <- "/home2/data/Projects/CWAS/share/ldopa/subinfo"
func_files <- as.character(read.table(file.path(sbase, "02_all_funcpaths_4mm.txt"))[,1])

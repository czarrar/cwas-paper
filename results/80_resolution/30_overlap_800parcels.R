...
odir <- file.path(base, "results/80_resolution")
...
print(metrics.others)

#' # Save
#+ save
cat("Save\n")
write.table(metrics.main, file=file.path(odir, "30_compare_voxelwise_and_800parcels.R"))
write.table(metrics.others, file=file.path(odir, "30_nsig_voxelwise_and_800parcels.R"))
